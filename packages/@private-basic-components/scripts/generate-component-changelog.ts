...
if (!componentNameMap.ConfigProvider) {
  componentNameMap.ConfigProvider = [];
}
componentNameMap.ConfigProvider.push(...fillComponentKey('Wave'));
if (!componentNameMap.Grid) {
  componentNameMap.Grid = [];
}
componentNameMap.Grid.push(...fillComponentKey('Row'));
componentNameMap.Grid.push(...fillComponentKey('Col'));
if (!componentNameMap.Message) {
  componentNameMap.Message = [];
}
componentNameMap.Message.push(...fillComponentKey('message'));
if (!componentNameMap.Notification) {
  componentNameMap.Notification = [];
}
